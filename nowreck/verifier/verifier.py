...
_OPPOSITE_CHANGE: dict[ClaimType, ChangeType] = {
    ...
    ClaimType.ADD_INTERFACE: ChangeType.REMOVE_INTERFACE,
    ClaimType.REMOVE_INTERFACE: ChangeType.ADD_INTERFACE,
    ClaimType.ADD_ENUM: ChangeType.REMOVE_ENUM,
    ClaimType.REMOVE_ENUM: ChangeType.ADD_ENUM,
    ClaimType.ADD_TYPE_ALIAS: ChangeType.REMOVE_TYPE_ALIAS,
